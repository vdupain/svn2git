...
echo "==="
echo "Converting svn:ignore properties into .gitignore.";
echo "==="
echo "#" > $PROJECT_ROOT/gitignore;
echo "# Ignores generated by SVN2GIT conversion" >> $PROJECT_ROOT/gitignore;
echo "#" >> $PROJECT_ROOT/gitignore;
echo "" >> $PROJECT_ROOT/gitignore;
git svn show-ignore --id svn/trunk >> $PROJECT_ROOT/gitignore;
cp $PROJECT_ROOT/gitignore .gitignore
#git add .gitignore;
#git commit --author='vdupain <vdupain@gmail.com>' -m 'Convert svn:ignore properties to .gitignore.'  || echo "failed to commit .gitignore, proceeding anyway";
...
echo "==="
git filter-branch -f --tree-filter "cp $PROJECT_ROOT/gitignore .gitignore" --tag-name-filter cat -- --all
